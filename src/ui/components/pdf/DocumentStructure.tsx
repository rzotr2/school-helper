          ...
          return (
            <div key={index} className="group">
              <button
                ...
                className="w-full flex items-center justify-between p-3 text-left hover:bg-slate-50/80 transition-colors cursor-pointer select-none"
                ...
                <div className="shrink-0 flex items-center gap-2">
                  {isNavigable ? (
                    <span
                      ...
                      className="inline-flex items-center gap-1 text-[11px] font-medium text-blue-600 hover:text-blue-800 hover:bg-blue-100/60 px-1.5 py-0.5 rounded transition-colors cursor-pointer"
